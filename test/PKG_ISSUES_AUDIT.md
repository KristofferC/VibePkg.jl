...
- **Fixing progress (worktree-isolated agent per bug, file-partitioned):**
  ...
  - **Excluded (features / design-calls, left as `@test_broken`):** #1568 (build-metadata version support), #3269 (raw-artifact file modes), #708 (git submodules), #2028 (`semver_spec` consistency).
